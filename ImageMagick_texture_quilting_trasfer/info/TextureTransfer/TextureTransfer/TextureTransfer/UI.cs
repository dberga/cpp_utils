...
namespace TextureTransfer
{
    ...
    {       
        ...
        private void performTextureTransferButton_Click(object sender, EventArgs e)
        {
            ...
            TextureTransferTool tt = new TextureTransferTool(new Bitmap(srcPictureBox.Image),
        ...
        void SynthesizedImageUpdated(object sender, ProgressChangedEventArgs e)
        {
             ...
             */
            progressLabel.Text = progressBar.Value + "% completed";
            this.synthesizedPictureBox.Image = report.Image;
            this.synthesizedPictureBox.Invalidate();
            timer.Start();
        }
